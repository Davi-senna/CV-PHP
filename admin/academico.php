                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Histórico acadêmico</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                ...
                                <form action="view/view_academico.php" method="POST">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="descricao" id="summernote">
                                            </textarea>
                                        </div>
                                    </div>
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-primary">
                                        <div class="card-header">
                                            <h3 class="card-title">Atuais experiências acadêmicas</h3>
                                        </div>
                                        <!-- /.card-header -->
                                                    ...
                                                    ?>
                                                        <div class="card" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                                                            <div class="card-body">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="progress-container progress-primary"><span class="progress-badge"><?php echo $results[$i]["experiencia"]; ?></span>
