                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="inputCidade">Nome da habilidade</label>
                                                <input type="text" class="col-6 form-control" name="nome_habilidade" id="inputHabilidade" placeholder="Digite o nome da habilidade">
                                            </div>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Atuais habilidades</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
